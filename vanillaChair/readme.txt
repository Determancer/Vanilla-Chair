...
坐着的时候输入 /trigger chairRemove 即可清除所坐的椅子。

玩家可以输入 /trigger chairMode 来开启胡萝卜钓竿模式。
该模式下玩家站在台阶或楼梯上时手持胡萝卜钓竿右击方块即可将该方块“转化”为椅子，空手右击即可坐上。
...
When sitting in a chair, use command /trigger chairRemove to remove it.

Use command /trigger chairMode to enable Carrot on a Stick mode.
In this mode, stand on a slab or a stair, use Carrot on a Stick on it to "transform" the block into a chair. 
Right-click with bare hands to sit on it.
